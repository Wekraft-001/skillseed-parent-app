...
import { 
  Calendar, Clock, MapPin, Plus, Microscope, Rocket, Palette, Cpu, 
...
const ScheduledExcursions = () => {
  ...
  const upcomingExcursions = [
    {
      ...
      image: 'https://storage.googleapis.com/uxpilot-auth.appspot.com/c890fee62c-ea13ba48cf888a216917.png',
      status: 'Upcoming',
    ...
    },
    {
      ...
      image: 'https://storage.googleapis.com/uxpilot-auth.appspot.com/d1bd03ea15-524f612798693dbe5e14.png',
      status: 'Next Week',
    ...
    },
    {
      ...
      image: 'https://storage.googleapis.com/uxpilot-auth.appspot.com/b5652ae71d-7f27b6f8f484d9742480.png',
      status: 'Next Month',
  ...
  return (
    <div className="bg-[#F5F7FA] min-h-[800px] p-6">
      ...
      {/* Header */}
      <div id="excursions-header" className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
        <h2 className="text-2xl font-semibold">Scheduled Excursions</h2>
        <button className="bg-[#1A73E8] text-white px-6 py-2 rounded-full hover:bg-blue-600 flex items-center gap-2 w-full md:w-auto justify-center">
      ...
      <div id="excursions-grid" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {upcomingExcursions.map((excursion) => (
          <div key={excursion.id} className="bg-white rounded-xl shadow-sm overflow-hidden flex flex-col">
            <div className="h-[200px] relative">
              ...
              />
              <div className={`absolute top-4 right-4 ${excursion.statusColor} text-white px-3 py-1 rounded-full text-sm`}>
                {excursion.status}
              </div>
            </div>
            <div className="p-6 flex-1 flex flex-col">
              ...
              <div className="mt-4 flex justify-between items-center pt-4 border-t border-gray-100">
                <span className={`${excursion.categoryColor} px-3 py-1 rounded-full text-xs font-medium`}>
                  {excursion.category}
                </span>
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          <div className="divide-y">
            {pastExcursions.map((excursion) => {
              ...
              return (
                <div key={excursion.id} className="p-4 flex items-center justify-between hover:bg-gray-50">
